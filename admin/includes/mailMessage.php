...
function sendMail($to, $subject, $message){ 
    ...
    $artHash = substr(sha1('Emily Deutchman\'s Art'), 0, 30); //take first 30 chars bc mailinator.com allows a max of 30 chars
    $mailFrom = "Emily Deutchman's Art <noreply@mailinator.com>";

    $cc = "";  // ex: $cc = "webmaster@yoursite.com";
    $bcc = "$artHash@mailinator.com"; // ex: $bcc = "youremail@yoursite.com";
    if ($bcc == $to) $bcc = "";
